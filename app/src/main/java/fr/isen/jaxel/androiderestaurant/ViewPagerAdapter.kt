...
class ViewPagerAdapter(val context: Context, val imageList: List<Int>) : PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val itemView: View = mLayoutInflater.inflate(R.layout.activity_details, container, false)

        // on below line we are initializing
        // our image view with the id.
        val imageView: ImageView = itemView.findViewById<View>(R.id.carrousel) as ImageView
